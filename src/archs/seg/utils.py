...
class _SimpleSegmentationModel(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, classifier: nn.Module, aux_classifier: Optional[nn.Module] = None, return_feats=True) -> None:
        super().__init__()
    ...
    def forward(self, x: Tensor, return_feats=False):
