...
class EDSR(nn.Module):
    def __init__(self, scale=4, n_blocks=16, n_feats=64, conv=default_conv,
                 in_chans=3, kernel_size=3, img_range=255.):
        ...
        # define body module
        m_body = [
            ResBlock(conv, n_feats, kernel_size) for _ in range(n_blocks)
        ]
